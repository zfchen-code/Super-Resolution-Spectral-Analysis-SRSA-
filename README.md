...
Start MATLAB in the `NewALLCode` directory, or change the MATLAB current folder to this directory, and add the source and example directories to the MATLAB path:

```matlab
rootDir = pwd;  % rootDir must be the NewALLCode directory
